...
public partial class system_get_Dynatown : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     public void Bind() {
         ...
         string sql = "select * from Dynatown where " + where;
     ...
     protected void delete_Click(object sender, EventArgs e)
     {
         ...
         if (bll.Delete(id)) { Maticsoft.Common.MessageBox.ShowAndRedirect(Page, "删除成功！", "get_Dynatown.aspx"); }
     ...
     protected void edit_Click(object sender, EventArgs e)
     {
         ...
         Response.Redirect("set_Dynatown.aspx?id=" + id, false);
     }

     protected void add_Click(object sender, EventArgs e)
     {
         Response.Redirect("set_Dynatown.aspx", false);
     }
