<%@ Page Language="C#" AutoEventWireup="true" CodeFile="get_customer.aspx.cs" Inherits="system_get_customer" %>
    ...
    <div>
           ...
           <div class="s_right">
                                        ...
                                        <div class="smenu_5">
                                            ...
                                            <asp:LinkButton ID="LinkButton1" CssClass="cha" OnClick="LinkButton1_Click" runat="server">查询</asp:LinkButton>
                                        </div>
