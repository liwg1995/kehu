...
public partial class system_get_Agent : System.Web.UI.Page
{
    ...
    public void Bind() {
        ...
        string sql = "select * from Agent where " + where ;
    ...
    protected void delete_Click(object sender, EventArgs e)
    {
        ...
        if (bll.Delete(id)) { Maticsoft.Common.MessageBox.ShowAndRedirect(Page, "删除成功！","get_Agent.aspx"); } 
    ...
    protected void edit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("set_Agent.aspx?id="+id,false);
    }
    protected void add_Click(object sender, EventArgs e)
    {
        Response.Redirect("set_Agent.aspx", false);
    }
